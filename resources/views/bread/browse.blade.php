                        ...
                        <table id="dataTable" class="table table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ trans('voyager::bread.' . strtolower(str_replace(' ', '_', $rows->display_name))) }}</th>
                                    @endforeach
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><i class="voyager-trash"></i> {{ trans('voyager::common.op_delete_ps1', ['msg' => $dataType->display_name_singular]) }}</h4>
                </div>
                <div class="modal-footer">
                    <form action="{{ route('voyager.'.$dataType->slug.'.index') }}" id="delete_form" method="POST">
                        ...
                        <input type="submit" class="btn btn-danger pull-right delete-confirm"
                               value="{{ trans('voyager::common.op_delete_ps2', ['msg' => $dataType->display_name_singular]) }}">
                    </form>
